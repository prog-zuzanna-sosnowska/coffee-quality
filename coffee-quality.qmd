...
```{r, echo=FALSE}
cup_point_washed = data_clean$Total.Cup.Points[data_clean$Processing.Method == "Washed / Wet"]
cup_point_natural = data_clean$Total.Cup.Points[data_clean$Processing.Method == "Natural / Dry"]

t.test(cup_point_washed, cup_point_natural)

shapiro.test(cup_point_washed)
